...
ps1boldGreen="\[$(tput bold)\]\[$(tput setaf 2)\]"
ps1boldWhite="\[$(tput bold)\]\[$(tput setaf 7)\]"
...
# bashed-git-prompt \m/
PS1='${ps1Dir}\w ${ps1Rst}${ps1boldGreen} $commitstot $commiticon\n ${ps1boldWhite}${ps1BgBlue} $gitprompt${ps1Rst} '
